...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { contacto: @proveedor.contacto, provedor: @proveedor.provedor } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { contacto: @proveedor.contacto, provedor: @proveedor.provedor } }
