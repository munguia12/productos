...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { articulo: @producto.articulo, disponibles: @producto.disponibles, existencia: @producto.existencia, stockmax: @producto.stockmax, stockmin: @producto.stockmin } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { articulo: @producto.articulo, disponibles: @producto.disponibles, existencia: @producto.existencia, stockmax: @producto.stockmax, stockmin: @producto.stockmin } }
